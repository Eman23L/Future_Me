...
- Every upcoming non-sleep activity receives reminders 24 hours, 8 hours, and 1 hour before its start time.
- Reminder copy reflects the lead time: tomorrow, about 8 hours, or about 1 hour.
- Notification taps deep-link to the activity date, where all activities for that day are shown.
